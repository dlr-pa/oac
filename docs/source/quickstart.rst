...
This fetches the data into a shared cache directory that OpenAirClim will use
by default. See :doc:`installation` for details and override options.
...
If you are planning on contributing to the development of OpenAirClim, you will
probably need to execute the `pytest <https://docs.pytest.org/en/stable/>`__
functions. These require additional test files, which you can create using
