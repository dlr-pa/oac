...
def fig_metadata(c_hash: str, v_oac: str, created: str) -> dict:
    """Create PNG metadata for generated figures.
    ...
    """
    return {"config_hash": c_hash, "oac_version": v_oac, "created": created}
