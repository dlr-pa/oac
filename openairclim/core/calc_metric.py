...
def calc_atr(config: dict, t_zero: float, horizon: float, dtemp_dict: dict) -> dict:
    """Calculates Average Temperature Response (ATR).
...
def calc_agwp(config: dict, t_zero: float, horizon: float, rf_dict: dict) -> dict:
    """Calculates the Absolute Global Warming Potential (AGWP).
...
def calc_aegwp(config: dict, t_zero: float, horizon: float, rf_dict: dict) -> dict:
    """Calculates the Absolute Efficacy-weighted Global Warming Potential (AEGWP).
